...
public class TelaPrincipalBase extends JFrame {
	...
	//Em private só a própria classe tem acesso
	private JPanel contentPane;
	//protected acessa pela subclasse que é a TelaPrincipal
	protected JTextField txfId;
	protected JTextField txfNome;
	protected JTextField txfTelefone;
	protected JTable table;
	//Para variavel botão aparecer aqui, deve converter para local field em configurações de design
	...
	public TelaPrincipalBase() {
		...
		gbc_txfTelefone.anchor = GridBagConstraints.NORTHWEST;
